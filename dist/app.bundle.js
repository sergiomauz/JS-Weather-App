...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nvar icons = function () {\n  var getFlagCountry = function getFlagCountry(country) {\n    return \"https://www.countryflags.io/\".concat(country, \"/flat/32.png\");\n  };\n\n  var getWeather = function getWeather(weather) {\n    return \"http://openweathermap.org/img/w/\".concat(weather, \".png\");\n  };\n\n  return {\n    getFlagCountry: getFlagCountry,\n    getWeather: getWeather\n  };\n}();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (icons);\n\n//# sourceURL=webpack:///./src/classes/icons.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nvar storage = function () {\n  var getCities = function getCities() {\n    return JSON.parse(localStorage.getItem('cities') || '[]');\n  };\n\n  var clearCities = function clearCities() {\n    return localStorage.removeItem('cities');\n  };\n\n  var getLastCity = function getLastCity() {\n    var CITIES = getCities();\n\n    if (CITIES.length > 0) {\n      return \"\".concat(CITIES[0].name, \", \").concat(CITIES[0].country);\n    }\n\n    return '';\n  };\n\n  var addCity = function addCity(country, city) {\n    var CITIES = JSON.parse(localStorage.getItem('cities') || '[]');\n    var INDEX_CITY = CITIES.map(function (c) {\n      return \"\".concat(c.name, \"|\").concat(c.country);\n    }).indexOf(\"\".concat(city, \"|\").concat(country));\n\n    if (INDEX_CITY >= 0) {\n      CITIES.splice(INDEX_CITY, 1);\n    }\n\n    CITIES.unshift({\n      country: country,\n      name: city\n    });\n    localStorage.setItem('cities', JSON.stringify(CITIES));\n  };\n\n  return {\n    addCity: addCity,\n    getCities: getCities,\n    clearCities: clearCities,\n    getLastCity: getLastCity\n  };\n}();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (storage);\n\n//# sourceURL=webpack:///./src/classes/storage.js?");

/***/ }),

/***/ "./src/classes/unsplash.js":
/*!*********************************!*\
  !*** ./src/classes/unsplash.js ***!
  \*********************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var babel_polyfill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! babel-polyfill */ \"./node_modules/babel-polyfill/lib/index.js\");\n/* harmony import */ var babel_polyfill__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(babel_polyfill__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _config_keys__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../config/keys */ \"./src/config/keys.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\n\nvar Unsplash = /*#__PURE__*/function () {\n  function Unsplash(description) {\n    _classCallCheck(this, Unsplash);\n\n    var UNSLPLASH_ID = _config_keys__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getUnsplashKey();\n    this.urlUnsplash = \"https://api.unsplash.com/search/photos?query=\".concat(description, \"&orientation=portrait&per_page=20&client_id=\").concat(UNSLPLASH_ID);\n  }\n\n  _createClass(Unsplash, [{\n    key: \"getImageUrl\",\n    value: function () {\n      var _getImageUrl = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n        var rndImageIndex;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                rndImageIndex = Math.floor(Math.random() * Math.floor(20));\n                _context.next = 3;\n                return fetch(this.urlUnsplash).then(function (responseUnsplash) {\n                  return responseUnsplash.json();\n                }).then(function (jsonUnsplash) {\n                  return jsonUnsplash.results[rndImageIndex].urls.small;\n                });\n\n              case 3:\n                this.imageUrl = _context.sent;\n                return _context.abrupt(\"return\", this.imageUrl);\n\n              case 5:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee, this);\n      }));\n\n      function getImageUrl() {\n        return _getImageUrl.apply(this, arguments);\n      }\n\n      return getImageUrl;\n    }()\n  }]);\n\n  return Unsplash;\n}();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (Unsplash);\n\n//# sourceURL=webpack:///./src/classes/unsplash.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var babel_polyfill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! babel-polyfill */ \"./node_modules/babel-polyfill/lib/index.js\");\n/* harmony import */ var babel_polyfill__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(babel_polyfill__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _config_keys__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../config/keys */ \"./src/config/keys.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\n\nvar Weather = /*#__PURE__*/function () {\n  function Weather(params) {\n    _classCallCheck(this, Weather);\n\n    var reqCity = params.reqCity,\n        reqUnits = params.reqUnits;\n    var WEATHER_APP_ID = _config_keys__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getOpenWeatherKey();\n    this.city = reqCity;\n\n    if (reqUnits) {\n      this.units = reqUnits;\n    } else {\n      this.units = 'metrics';\n    }\n\n    this.urlAPI = \"http://api.openweathermap.org/data/2.5/weather?q=\".concat(this.city, \"&appid=\").concat(WEATHER_APP_ID, \"&units=\").concat(this.units);\n  }\n\n  _createClass(Weather, [{\n    key: \"getInfo\",\n    value: function getInfo() {\n      return this.info;\n    }\n  }, {\n    key: \"getTemperature\",\n    value: function getTemperature(temp) {\n      if (this.units === 'imperial') {\n        return \"\".concat(parseFloat(temp).toFixed(2), \" \\xB0F\");\n      }\n\n      return \"\".concat(parseFloat(temp - 273.15).toFixed(2), \" \\xB0C\");\n    }\n  }, {\n    key: \"request\",\n    value: function () {\n      var _request = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n        var _this = this;\n\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                _context.next = 2;\n                return fetch(this.urlAPI).then(function (responseData) {\n                  return responseData.json();\n                }).then(function (jsonData) {\n                  var code = 0;\n                  var data = {\n                    message: jsonData.message\n                  };\n\n                  if (jsonData.cod === 200) {\n                    code = 1;\n                    data = {\n                      message: 'OK',\n                      coordinates: {\n                        latitude: jsonData.coord.lat,\n                        longitude: jsonData.coord.lon\n                      },\n                      country: jsonData.sys.country,\n                      city: jsonData.name,\n                      icon: jsonData.weather[0].icon,\n                      description: jsonData.weather[0].description,\n                      main: {\n                        humidity: jsonData.main.humidity,\n                        temp: _this.getTemperature(jsonData.main.temp),\n                        feels_like: _this.getTemperature(jsonData.main.feels_like),\n                        temp_min: _this.getTemperature(jsonData.main.temp_min),\n                        temp_max: _this.getTemperature(jsonData.main.temp_max)\n                      }\n                    };\n                  } else if (jsonData.cod === 401) {\n                    code = -1;\n                  }\n\n                  return {\n                    result: code,\n                    data: data\n                  };\n                })[\"catch\"](function (err) {\n                  return {\n                    result: -1,\n                    data: err.message\n                  };\n                });\n\n              case 2:\n                this.info = _context.sent;\n                return _context.abrupt(\"return\", this.info);\n\n              case 4:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee, this);\n      }));\n\n      function request() {\n        return _request.apply(this, arguments);\n      }\n\n      return request;\n    }()\n  }]);\n\n  return Weather;\n}();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (Weather);\n\n//# sourceURL=webpack:///./src/classes/weather.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _rendering_newelement__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../rendering/newelement */ \"./src/rendering/newelement.js\");\n/* harmony import */ var _rendering_elementslist__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../rendering/elementslist */ \"./src/rendering/elementslist.js\");\n/* harmony import */ var _rendering_newmap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../rendering/newmap */ \"./src/rendering/newmap.js\");\n/* harmony import */ var _classes_storage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../classes/storage */ \"./src/classes/storage.js\");\n/* harmony import */ var _classes_weather__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../classes/weather */ \"./src/classes/weather.js\");\n/* harmony import */ var _classes_unsplash__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../classes/unsplash */ \"./src/classes/unsplash.js\");\n/* harmony import */ var _classes_icons__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../classes/icons */ \"./src/classes/icons.js\");\n/* harmony import */ var _sidebar__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./sidebar */ \"./src/components/sidebar.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\n\n\n\n\n\n\n\nvar form = function () {\n  var formElement;\n  var INFO_WEATHER_ELEMENT_ID = 'weather-info';\n  var MAP_WEATHER_ELEMENT_ID = 'weather-map';\n  var INPUT_CITY_NAME_ID = 'cityname';\n  var DIV_ERROR_ID = 'error-message';\n  var buttonRequest = Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n    tag: 'button',\n    classes: 'btn btn-primary mt-2 mt-sm-0 ml-0 ml-sm-2',\n    html: 'Request',\n    attributes: {\n      type: 'button'\n    }\n  });\n  var buttonChangeUnits = Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n    tag: 'button',\n    classes: 'btn btn-sm btn-success mt-2 mt-sm-0 ml-0 ml-sm-2',\n    html: 'to Fahrenheit',\n    attributes: {\n      type: 'button'\n    }\n  });\n\n  var showErrorRequest = function showErrorRequest(errorType) {\n    var divError = formElement.querySelector(\"div[id='\".concat(DIV_ERROR_ID, \"']\"));\n    var map = formElement.querySelector(\"div[id='\".concat(MAP_WEATHER_ELEMENT_ID, \"']\"));\n    var info = formElement.querySelector(\"div[id='\".concat(INFO_WEATHER_ELEMENT_ID, \"']\"));\n    document.body.style = '';\n    map.innerHTML = '';\n    info.innerHTML = '';\n    divError.innerHTML = '';\n\n    if (errorType === 0) {\n      divError.className = 'alert alert-warning';\n      divError.innerHTML = 'City not found!.';\n    } else {\n      divError.className = 'alert alert-danger';\n      divError.innerHTML = 'You must set a valid API Key.';\n    }\n  };\n\n  var showWeatherInfo = /*#__PURE__*/function () {\n    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(weatherinfo, maprequired) {\n      var map, info, input, errorMessage, newWeatherImage, imageUrl;\n      return regeneratorRuntime.wrap(function _callee$(_context) {\n        while (1) {\n          switch (_context.prev = _context.next) {\n            case 0:\n              map = formElement.querySelector(\"div[id='\".concat(MAP_WEATHER_ELEMENT_ID, \"']\"));\n              info = formElement.querySelector(\"div[id='\".concat(INFO_WEATHER_ELEMENT_ID, \"']\"));\n              input = formElement.querySelector(\"input[id='\".concat(INPUT_CITY_NAME_ID, \"']\"));\n              errorMessage = formElement.querySelector(\"div[id='\".concat(DIV_ERROR_ID, \"']\"));\n              errorMessage.classList.add('d-none');\n              input.value = '';\n\n              if (!maprequired) {\n                _context.next = 14;\n                break;\n              }\n\n              newWeatherImage = new _classes_unsplash__WEBPACK_IMPORTED_MODULE_5__[\"default\"](weatherinfo.data.description);\n              _context.next = 10;\n              return newWeatherImage.getImageUrl();\n\n            case 10:\n              imageUrl = _context.sent;\n              document.body.style = \"background: linear-gradient(rgba(255,255,255,.5), rgba(255,255,255,.5)), url(\\\"\".concat(imageUrl, \"\\\"); background-repeat:no-repeat; background-size:cover;\");\n              map.innerHTML = '';\n              map.appendChild(Object(_rendering_newmap__WEBPACK_IMPORTED_MODULE_2__[\"default\"])({\n                latitude: weatherinfo.data.coordinates.latitude,\n                longitude: weatherinfo.data.coordinates.longitude\n              }));\n\n            case 14:\n              info.innerHTML = '';\n              info.appendChild(Object(_rendering_elementslist__WEBPACK_IMPORTED_MODULE_1__[\"default\"])({\n                container: Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n                  tag: 'div',\n                  classes: 'form-group'\n                }),\n                childs: [Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n                  tag: 'label',\n                  classes: 'font-weight-bold',\n                  attributes: {\n                    \"for\": 'spanCity'\n                  },\n                  html: 'City:'\n                }), Object(_rendering_elementslist__WEBPACK_IMPORTED_MODULE_1__[\"default\"])({\n                  container: Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n                    tag: 'div',\n                    classes: 'form-control border-0',\n                    attributes: {\n                      id: 'spanCity'\n                    }\n                  }),\n                  childs: [Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n                    tag: 'img',\n                    attributes: {\n                      src: _classes_icons__WEBPACK_IMPORTED_MODULE_6__[\"default\"].getFlagCountry(weatherinfo.data.country),\n                      style: 'margin-top:-5px;'\n                    }\n                  }), Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n                    tag: 'span',\n                    classes: 'ml-2',\n                    html: weatherinfo.data.city\n                  })]\n                })]\n              }));\n              info.appendChild(Object(_rendering_elementslist__WEBPACK_IMPORTED_MODULE_1__[\"default\"])({\n                container: Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n                  tag: 'div',\n                  classes: 'form-group'\n                }),\n                childs: [Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n                  tag: 'label',\n                  classes: 'font-weight-bold',\n                  attributes: {\n                    \"for\": 'spanWeather'\n                  },\n                  html: 'Weather:'\n                }), Object(_rendering_elementslist__WEBPACK_IMPORTED_MODULE_1__[\"default\"])({\n                  container: Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n                    tag: 'div',\n                    classes: 'form-control border-0',\n                    attributes: {\n                      id: 'spanWeather'\n                    }\n                  }),\n                  childs: [Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n                    tag: 'img',\n                    attributes: {\n                      src: _classes_icons__WEBPACK_IMPORTED_MODULE_6__[\"default\"].getWeather(\"\".concat(weatherinfo.data.icon)),\n                      style: 'margin-top:-8px;margin-left:-5px;width:40px;height:40px;'\n                    }\n                  }), Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n                    tag: 'span',\n                    classes: 'ml-2',\n                    html: \"\".concat(weatherinfo.data.description)\n                  })]\n                })]\n              }));\n              info.appendChild(Object(_rendering_elementslist__WEBPACK_IMPORTED_MODULE_1__[\"default\"])({\n                container: Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n                  tag: 'div',\n                  classes: 'form-group'\n                }),\n                childs: [Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n                  tag: 'label',\n                  classes: 'font-weight-bold',\n                  attributes: {\n                    \"for\": 'spanHumidity'\n                  },\n                  html: 'Humidity:'\n                }), Object(_rendering_elementslist__WEBPACK_IMPORTED_MODULE_1__[\"default\"])({\n                  container: Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n                    tag: 'div',\n                    classes: 'form-control border-0',\n                    attributes: {\n                      id: 'spanHumidity'\n                    }\n                  }),\n                  childs: [Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n                    tag: 'span',\n                    classes: 'ml-2',\n                    html: \"\".concat(weatherinfo.data.main.humidity, \"%\")\n                  })]\n                })]\n              }));\n              info.appendChild(Object(_rendering_elementslist__WEBPACK_IMPORTED_MODULE_1__[\"default\"])({\n                container: Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n                  tag: 'div',\n                  classes: 'form-group'\n                }),\n                childs: [Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n                  tag: 'label',\n                  classes: 'font-weight-bold',\n                  attributes: {\n                    \"for\": 'spanTemps'\n                  },\n                  html: 'Temperature:'\n                }), buttonChangeUnits, Object(_rendering_elementslist__WEBPACK_IMPORTED_MODULE_1__[\"default\"])({\n                  container: Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n                    tag: 'ul',\n                    attributes: {\n                      id: 'spanTemps'\n                    }\n                  }),\n                  childs: [Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n                    tag: 'li',\n                    html: \"Current: \".concat(weatherinfo.data.main.temp)\n                  }), Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n                    tag: 'li',\n                    html: \"Thermal Sensation: \".concat(weatherinfo.data.main.feels_like)\n                  }), Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n                    tag: 'li',\n                    html: \"Minimum: \".concat(weatherinfo.data.main.temp_min)\n                  }), Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n                    tag: 'li',\n                    html: \"Maximum: \".concat(weatherinfo.data.main.temp_max)\n                  })]\n                })]\n              }));\n\n            case 19:\n            case \"end\":\n              return _context.stop();\n          }\n        }\n      }, _callee);\n    }));\n\n    return function showWeatherInfo(_x, _x2) {\n      return _ref.apply(this, arguments);\n    };\n  }();\n\n  var requestWeather = /*#__PURE__*/function () {\n    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(units, city, maprequired) {\n      var weather, newRequest;\n      return regeneratorRuntime.wrap(function _callee2$(_context2) {\n        while (1) {\n          switch (_context2.prev = _context2.next) {\n            case 0:\n              weather = new _classes_weather__WEBPACK_IMPORTED_MODULE_4__[\"default\"]({\n                reqCity: city,\n                reqUnits: units\n              });\n\n              if (!(city.length > 0)) {\n                _context2.next = 6;\n                break;\n              }\n\n              _context2.next = 4;\n              return weather.request();\n\n            case 4:\n              newRequest = _context2.sent;\n\n              if (newRequest.result === 1) {\n                _classes_storage__WEBPACK_IMPORTED_MODULE_3__[\"default\"].addCity(newRequest.data.country, newRequest.data.city);\n                _sidebar__WEBPACK_IMPORTED_MODULE_7__[\"default\"].loadCitiesNodes(_classes_storage__WEBPACK_IMPORTED_MODULE_3__[\"default\"].getCities());\n                showWeatherInfo(newRequest, maprequired);\n              } else {\n                showErrorRequest(newRequest.result);\n              }\n\n            case 6:\n            case \"end\":\n              return _context2.stop();\n          }\n        }\n      }, _callee2);\n    }));\n\n    return function requestWeather(_x3, _x4, _x5) {\n      return _ref2.apply(this, arguments);\n    };\n  }();\n\n  var create = function create() {\n    var inputRequest = Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n      tag: 'input',\n      attributes: {\n        type: 'text',\n        id: \"\".concat(INPUT_CITY_NAME_ID),\n        autocomplete: 'off'\n      },\n      classes: 'form-control ml-0 ml-sm-2'\n    });\n    var divError = Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n      tag: 'div',\n      classes: 'd-none',\n      attributes: {\n        id: \"\".concat(DIV_ERROR_ID)\n      }\n    });\n    buttonRequest.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {\n      return regeneratorRuntime.wrap(function _callee3$(_context3) {\n        while (1) {\n          switch (_context3.prev = _context3.next) {\n            case 0:\n              _context3.next = 2;\n              return requestWeather('metrics', inputRequest.value, true);\n\n            case 2:\n            case \"end\":\n              return _context3.stop();\n          }\n        }\n      }, _callee3);\n    })));\n    inputRequest.addEventListener('keydown', function (e) {\n      if (e.keyCode === 13) {\n        buttonRequest.click();\n        e.preventDefault();\n      }\n    });\n    formElement = Object(_rendering_elementslist__WEBPACK_IMPORTED_MODULE_1__[\"default\"])({\n      container: Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n        tag: 'div',\n        classes: 'd-flex flex-column'\n      }),\n      childs: [Object(_rendering_elementslist__WEBPACK_IMPORTED_MODULE_1__[\"default\"])({\n        container: Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n          tag: 'div',\n          classes: 'row justify-content-center'\n        }),\n        childs: [Object(_rendering_elementslist__WEBPACK_IMPORTED_MODULE_1__[\"default\"])({\n          container: Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n            tag: 'div',\n            classes: 'col-12'\n          }),\n          childs: [Object(_rendering_elementslist__WEBPACK_IMPORTED_MODULE_1__[\"default\"])({\n            container: Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n              tag: 'div',\n              classes: 'form-inline pb-3 border-bottom justify-content-center'\n            }),\n            childs: [inputRequest, buttonRequest]\n          }), Object(_rendering_elementslist__WEBPACK_IMPORTED_MODULE_1__[\"default\"])({\n            container: Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n              tag: 'div',\n              classes: 'form-inline mt-2 justify-content-center'\n            }),\n            childs: [divError]\n          })]\n        })]\n      }), Object(_rendering_elementslist__WEBPACK_IMPORTED_MODULE_1__[\"default\"])({\n        container: Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n          tag: 'div',\n          classes: 'row justify-content-center mt-3'\n        }),\n        childs: [Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n          tag: 'div',\n          classes: 'col-12 col-lg-6 mt-2 mt-lg-0 order-last order-lg-first',\n          attributes: {\n            id: \"\".concat(MAP_WEATHER_ELEMENT_ID)\n          }\n        }), Object(_rendering_newelement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n          tag: 'div',\n          classes: 'col-12 col-lg-6 mt-2 mt-lg-0',\n          attributes: {\n            id: \"\".concat(INFO_WEATHER_ELEMENT_ID)\n          }\n        })]\n      })]\n    });\n    buttonChangeUnits.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {\n      var city;\n      return regeneratorRuntime.wrap(function _callee4$(_context4) {\n        while (1) {\n          switch (_context4.prev = _context4.next) {\n            case 0:\n              city = _classes_storage__WEBPACK_IMPORTED_MODULE_3__[\"default\"].getLastCity();\n\n              if (!buttonChangeUnits.innerHTML.includes('Celsius')) {\n                _context4.next = 7;\n                break;\n              }\n\n              buttonChangeUnits.innerHTML = 'to Fahrenheit';\n              _context4.next = 5;\n              return requestWeather('metrics', city, false);\n\n            case 5:\n              _context4.next = 10;\n              break;\n\n            case 7:\n              buttonChangeUnits.innerHTML = 'to Celsius';\n              _context4.next = 10;\n              return requestWeather('imperial', city, false);\n\n            case 10:\n            case \"end\":\n              return _context4.stop();\n          }\n        }\n      }, _callee4);\n    })));\n    return formElement;\n  };\n\n  var get = function get() {\n    return formElement;\n  };\n\n  return {\n    create: create,\n    get: get\n  };\n}();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (form);\n\n//# sourceURL=webpack:///./src/components/form.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nvar keys = function () {\n  var getOpenWeatherKey = function getOpenWeatherKey() {\n    return '860baa5edd1cd9b42075446e14ae99c3';\n  };\n\n  var getUnsplashKey = function getUnsplashKey() {\n    return 'gB7YqSb7CJtUq2XxzFeGQrf1z1C9-9JBSWHIFgIwhCk';\n  };\n\n  return {\n    getOpenWeatherKey: getOpenWeatherKey,\n    getUnsplashKey: getUnsplashKey\n  };\n}();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (keys);\n\n//# sourceURL=webpack:///./src/config/keys.js?");
